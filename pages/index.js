      ...
      <main className='flex flex-col items-start flex-1 max-w-4xl px-4 py-8 md:py-12'>
        ...
        <div className='mt-12 text-gray-900'>
          ...
          <p className='mt-2'>
            ...
            是 Clash 的一项功能，可以让用户从指定路径动态加载代理服务器列表。使用这个功能你可以将
            Clash 订阅里面的代理服务器提取出来，放到你喜欢的配置文件里，也可以将多个 Clash
            订阅里的代理服务器混合到一个配置文件里。External Group 则是 Proxy Provider 在 Surge
            里的叫法，作用是一样的。
          </p>
        </div>
        ...
        <div className='w-full text-gray-900 mt-14'>
          <h3 className='text-lg md:text-xl font-bold'>怎么自己部署转换工具？</h3>
          <p className='mt-2'>
            使用工具时，{host} 的拥有者将会有权限查看到你的订阅地址，如果你不想让给他人这种权限，
          ...
          <ul className='mt-1'>
            ...
            <li>
              4. 选择 New Project，点击 proxy-provider-converter 旁边的 Import 按钮, 点击 PERSONAL
              ACCOUNT 旁边的 Select，最后点击 Deploy
            </li>
            <li>5. 等待部署完成后点击 Vercel 项目面板上的 Visit 按钮就可以访问你部署的版本了</li>
          </ul>
        </div>
        <div className='w-full text-gray-900 mt-14'>
